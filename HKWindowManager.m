...
+(void)initialize {
    ...
    NSDictionary *appDefaults = [NSDictionary dictionaryWithObject:[NSNumber numberWithFloat:1.0] forKey:@"tournamentCloseLobbyDelayKey"];
...
-(NSRect)getPotBounds:(AXUIElementRef)windowRef
{
	...
	boundBox.origin.y = 23.57 + (0.1068 * tempSize.height) + windowRect.origin.y;
