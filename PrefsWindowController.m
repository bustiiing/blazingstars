...
-(void)awakeFromNib
{
	...
	// dispatch methods.
	tagDict = [NSDictionary dictionaryWithObjectsAndKeys:[NSArray arrayWithObjects:[NSNumber numberWithInt:1],@"FoldKey"],[NSValue valueWithPointer:fold],
			   [NSArray arrayWithObjects:[NSNumber numberWithInt:2],@"CallKey"],[NSValue valueWithPointer:call],
			   [NSArray arrayWithObjects:[NSNumber numberWithInt:3],@"BetKey"],[NSValue valueWithPointer:bet],
			   [NSArray arrayWithObjects:[NSNumber numberWithInt:4],@"CheckFoldKey"],[NSValue valueWithPointer:checkFold], 
			   [NSArray arrayWithObjects:[NSNumber numberWithInt:5],@"FoldToAnyKey"],[NSValue valueWithPointer:foldToAny], 
			   [NSArray arrayWithObjects:[NSNumber numberWithInt:6],@"CheckCallKey"],[NSValue valueWithPointer:checkCall], 
			   [NSArray arrayWithObjects:[NSNumber numberWithInt:7],@"CheckCallAnyKey"],[NSValue valueWithPointer:checkCallAny], 
			   [NSArray arrayWithObjects:[NSNumber numberWithInt:8],@"BetRaiseKey"],[NSValue valueWithPointer:betRaise], 
			   [NSArray arrayWithObjects:[NSNumber numberWithInt:9],@"BetRaiseAnyKey"],[NSValue valueWithPointer:betRaiseAny], 
			   [NSArray arrayWithObjects:[NSNumber numberWithInt:10],@"SitOutKey"],[NSValue valueWithPointer:sitOut],
			   [NSArray arrayWithObjects:[NSNumber numberWithInt:11],@"AutoPostKey"],[NSValue valueWithPointer:autoPost],
			   [NSArray arrayWithObjects:[NSNumber numberWithInt:12],@"SitOutAllTablesKey"],[NSValue valueWithPointer:sitOutAllTables], 
			   [NSArray arrayWithObjects:[NSNumber numberWithInt:13],@"IncrementKey"],[NSValue valueWithPointer:increment], 
			   [NSArray arrayWithObjects:[NSNumber numberWithInt:14],@"DecrementKey"],[NSValue valueWithPointer:decrement],
			   [NSArray arrayWithObjects:[NSNumber numberWithInt:15],@"leaveTable"],[NSValue valueWithPointer:leaveTable],
			   [NSArray arrayWithObjects:[NSNumber numberWithInt:16],@"leaveAllTables"],[NSValue valueWithPointer:leaveAllTables], 
			   [NSArray arrayWithObjects:[NSNumber numberWithInt:17],@"PotBetOneKey"],[NSValue valueWithPointer:potBetOne], 
			   [NSArray arrayWithObjects:[NSNumber numberWithInt:18],@"PotBetTwoKey"],[NSValue valueWithPointer:potBetTwo], 
			   [NSArray arrayWithObjects:[NSNumber numberWithInt:19],@"PotBetThreeKey"],[NSValue valueWithPointer:potBetThree], 
			   [NSArray arrayWithObjects:[NSNumber numberWithInt:20],@"PotBetFourKey"],[NSValue valueWithPointer:potBetFour],
			   [NSArray arrayWithObjects:[NSNumber numberWithInt:21],@"AllInKey"],[NSValue valueWithPointer:allIn],
			   [NSArray arrayWithObjects:[NSNumber numberWithInt:22],@"ToggleAllKey"],[NSValue valueWithPointer:toggleAllHotkeys],
			   [NSArray arrayWithObjects:[NSNumber numberWithInt:99],@"DebugKey"],[NSValue valueWithPointer:debugHK],			   
			   nil];
